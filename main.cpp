...
public:
  ...
  void ParseCommandLine(int argc, char **argv) {
    static const char *help = "Paycon-seeder\n"
...
static const string mainnet_seeds[] = {"ec2-54-245-128-4.us-west-2.compute.amazonaws.com", "dnsseed.ec2-54-245-128-4.us-west-2.compute.amazonaws.com", ""};
static const string testnet_seeds[] = {""};
static const string *seeds = mainnet_seeds;

extern "C" void* ThreadSeeder(void*) {
  if (!fTestNet){
    db.Add(CService("kjy2eqzk4zwi5zd3.onion", 9458), true);
  }
  do {
